...
const ModelViewer = ({
  ...
  const capture = () => {
    ...
    a.download = 'team_asterix_baja_3d.png';
    a.href = urlPNG;
    a.click();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <directionalLight position={[-6, 4, 5]} intensity={fillLightIntensity} />
        <directionalLight position={[0, 6, -6]} intensity={rimLightIntensity} color="#0ea5e9" />
